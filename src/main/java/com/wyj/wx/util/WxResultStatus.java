...
public enum WxResultStatus {
    ...
    WxResultStatus(int code, String msg){
        this.code = code;
        this.msg = msg;
    }
    ...
    public static int getCode(String define){
        try {
            return WxResultStatus.valueOf(define).code;
    ...
    public static String getMsg(String define){
        try {
            return WxResultStatus.valueOf(define).msg;
        } catch (IllegalArgumentException e) {
            log.error("undefined error code: {}", define);
    ...
    public static String getMsg(int code){
        for(WxResultStatus err : WxResultStatus.values()){
            if(err.code==code){
                return err.msg;
            }
        }
